...
# Define features and corresponding model predictions
features_choking = ['Dopamine', 'Dopamine + Alpha_Synuclein', 'Dopamine + Alpha_Synuclein + SpO2']
accuracies_choking = [accuracy_choking, accuracy_choking, accuracy_choking]

features_fall = ['Dopamine', 'Dopamine + Alpha_Synuclein', 'Dopamine + Alpha_Synuclein + Gyrometer_X']
accuracies_fall = [accuracy_fall, accuracy_fall, accuracy_fall]

# Plotting the accuracy graphs
plt.figure(figsize=(10, 6))

# Plot for choking prediction
plt.plot(features_choking, accuracies_choking, marker='o', label='Choking Prediction')
# Annotate each point with its accuracy value
for i, txt in enumerate(accuracies_choking):
    plt.annotate(f'{txt:.4f}', (features_choking[i], accuracies_choking[i]), textcoords="offset points", xytext=(0,10), ha='center')

# Plot for fall detection prediction
plt.plot(features_fall, accuracies_fall, marker='o', label='Fall Detection Prediction')
# Annotate each point with its accuracy value
for i, txt in enumerate(accuracies_fall):
    plt.annotate(f'{txt:.4f}', (features_fall[i], accuracies_fall[i]), textcoords="offset points", xytext=(0,10), ha='center')
